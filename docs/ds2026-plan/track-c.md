...
| **TextLink** | `TextLink.css.ts:7,13,32`; `TextLink.tsx:76,113` | `typography.colour.link`(green600); JSX `colour` | `color.interactive.link`(green600) / `color.button.linkedText.*` (W1-P2, unconfirmed §6-Q3) | N | ✅ (interactive.link) | **W3c-P2** | folded 3c (not yet landed) |

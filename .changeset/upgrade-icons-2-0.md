...
> Note: consumers still on `@autoguru/icons` 1.x must upgrade to 2.0.0. Reviewers may wish to release this as a major bump if that peer-dependency change is treated as breaking for downstream apps.

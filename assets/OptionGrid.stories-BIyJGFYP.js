import{r as v,e as A}from"./iframe-PgZJ2afo.js";import{O as h}from"./OptionGrid-CJKCX4ew.js";import{I as x,a as k,b as y,c as E}from"./TyreIcon-Dd2GTIRm.js";import"./preload-helper-D9Z9MdNV.js";import"./useFocusRing-CIjBh93L.js";import"./index-DI0fRIM3.js";import"./index-C7Mw8gWO.js";import"./useLabel-CXubnL9u.js";import"./context-q5X72OkG.js";import"./LoadingBox-Bovhks7M.js";import"./Icon-C4-JpBuo.js";import"./resolveResponsiveProps-CdSEa9T5.js";import"./CheckIcon-BaYN2ktu.js";const{expect:e,fn:C,getAllByRole:f,within:I,userEvent:S}=__STORYBOOK_MODULE_TEST__,u=[{label:"100,00km / 60 months",name:"100km/60"},{label:"110,000km / 66 months",name:"110km/66"},{label:"120,000km / 72 months",name:"120km/72"},{label:"130,000km / 78 months",name:"130km/78",disabled:!0},{label:"140,000km / 84 months",name:"140km/84"},{label:"150,000km / 90 months",name:"150km/90"},{label:"160,000km / 96 months",name:"160km/96"},{label:"170,000km / 104 months",name:"170km/102",disabled:!0},{label:"180,000km / 110 months",name:"180km/110",disabled:!0},{label:"190,000km / 116 months",name:"190km/116"}],g=[{label:"Re-gas Air-conditioning",icon:x,name:"regas-aircon"},{label:"Front Windscreen Replacement",icon:k,name:"front-windscreen"},{label:"Roadworthy Inspection",icon:y,name:"roadworthy"},{label:"Wheel Alignment",icon:E,name:"wheel-alignment"}],H=[{label:"Option A",name:"a",description:"This is description A"},{label:"Option B",name:"b",description:"This is description B"},{label:"Option C",name:"c",description:"This is description C"}],F={title:"Forms & Input Fields/Option Grid",tags:[],component:h,args:{label:"Select car servicing options",items:g,columns:"2",indicator:"checkbox",selectionMode:"multiple",onSelectionChange:C(),isLoading:!1,testId:"demo-option-grid"}},d={args:{label:"Select options",items:H,indicator:"checkbox"},play:async({args:t,canvasElement:m,step:n})=>{const p=t.items,c=I(m),l="aria-selected";await new Promise(s=>setTimeout(s,25));const b=c.getAllByRole("listbox")[0],a=f(b,"option");await n("Group renders label and attributes",async()=>{await e(b).toHaveAccessibleName(`${t.label}`),await e(b).toHaveAttribute("data-testid",t.testId)}),await n("Options render label and description",async()=>{for(const[s,o]of a.entries()){const w=p[s];await e(o).toHaveTextContent(w.label),await e(o).toHaveTextContent(w.description??""),await e(o).toHaveAttribute("data-key",w.name)}}),await n("Selected states and onChange event",async()=>{for(const s of[0,2]){const o=a[s];await S.click(o),await e(t.onSelectionChange).toHaveBeenCalled(),await e(o).toHaveAttribute(l,"true")}await e(a[1]).toHaveAttribute(l,"false")}),await n("Keyboard interaction",async()=>{await S.keyboard("[ArrowLeft][ArrowLeft][Enter][ArrowRight][ArrowRight][Enter]"),await e(t.onSelectionChange).toHaveBeenCalled(),await e(a[0]).toHaveAttribute(l,"false"),await e(a[2]).toHaveAttribute(l,"false")})}},i={args:{items:g}},r={args:{label:"Select a scheduled service",items:u,selectionMode:"single",indicator:"radio"},render:t=>{const[m,n]=v.useState(new Set([u[0].name])),p=c=>{n(c),console.info("Storybook OptionGrid: Selected item =",...c)};return A.createElement(h,{...t,selectedKeys:m,onSelectionChange:p})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...i.parameters?.docs?.source},description:{story:"Uncontrolled with custom icons",...i.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
...
\`\`\``,...r.parameters?.docs?.description}}};const N=["Simple","UncontrolledWithIcons","SingleSelectionControlled"];export{d as Simple,r as SingleSelectionControlled,i as UncontrolledWithIcons,N as __namedExportsOrder,F as default};

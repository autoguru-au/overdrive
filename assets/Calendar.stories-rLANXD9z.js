import{C as l,$ as d,a as o}from"./Calendar-e9Qv94br.js";import{e as i,i as c}from"./iframe-Bgojgvh3.js";import{M as p}from"./mockdate-CfjpTsV-.js";import"./useControlledState-DIABvQa8.js";import"./useButton-D9nfGU24.js";import"./index-DX6SYUsH.js";import"./index-Beel18g2.js";import"./LocalizedStringFormatter-Bbt7CFPC.js";import"./Icon-C6zvq-dF.js";import"./resolveResponsiveProps-bZ1ETmzV.js";import"./ChevronLeftIcon-shL_GX9M.js";import"./ChevronRightIcon-BeUS1M_X.js";import"./preload-helper-PPVm8Dsz.js";const m="2025-12-31",k={title:"Components/Calendar",tags:["new"],component:l,beforeEach:()=>{c()&&p.set(m)},parameters:{layout:"padded"},argTypes:{allowPastDate:{control:"boolean",description:"Allow selecting dates in the past"}}},t={args:{allowPastDate:!1},render:e=>i.createElement(l,{...e,onChange:a=>console.log("Selected:",a)})},n={args:{allowPastDate:!0,calendarOptions:{defaultValue:o("2025-12-25")}},render:e=>i.createElement(l,{...e,onChange:a=>console.log("Selected:",a)})},s={args:{calendarOptions:{minValue:o("2025-06-05"),maxValue:o("2025-06-25"),defaultValue:o("2025-06-15")}},render:e=>i.createElement(l,{...e,onChange:a=>console.log("Selected:",a)})},r={args:{allowPastDate:!0,calendarOptions:{isDateUnavailable:e=>d(e,"en-AU")}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    allowPastDate: false
  },
  ...
  render: args => <Calendar {...args} onChange={date => console.log('Selected:', date)} />
}`,...s.parameters?.docs?.source},description:{story:`Calendar with min and max date restrictions.
Demonstrates simple date range limiting using string-based min/max values.`,...s.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    allowPastDate: true,
    calendarOptions: {
...
}`,...r.parameters?.docs?.source},description:{story:`Demonstrates disabling weekends using the \`isDateUnavailable\` function with the
...
\`\`\``,...r.parameters?.docs?.description}}};const x=["Standard","InitialValue","MinMax","DisabledWeekends"];export{r as DisabledWeekends,n as InitialValue,s as MinMax,t as Standard,x as __namedExportsOrder,k as default};

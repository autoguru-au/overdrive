import{e as o,B as t,H as p}from"./iframe-CapgcpQw.js";import{F as c}from"./FillHeightBox-DEX0F_0S.js";import{T as g}from"./Text-BGIV1zEQ.js";import{S as u}from"./StickyBox-DOsdC4Np.js";import"./useResponsiveValue-B9qgNas7.js";import"./useMedia-C37TyS9S.js";import"./resolveResponsiveProps-D2UjvlFZ.js";import"./ScrollPane-D3OFRksL.js";const E={title:"Layout/StickyBox",component:u},e={args:{top:"none",width:"full"},render:h=>o.createElement(c,{rounded:!0,includeMobile:!0,bottomGap:"5",width:"full",backgroundColour:"white",borderColour:"gray",borderWidth:"1",boxShadow:"1",height:"full",borderRadius:"1"},o.createElement(u,{...h},o.createElement(t,{marginTop:"8",padding:"3",width:"full",backgroundColour:"yellow700",borderRadius:"1",overflow:"hidden"},o.createElement(p,{as:"h2",colour:"white"},"I'm a sticky header"))),o.createElement(t,{padding:"5",width:"full",style:{minHeight:"300vh"}},Array.from({length:100}).map((w,a)=>o.createElement(g,{key:a,as:"p"},"I am page content ",a+1))))},r={...e,args:{...e.args,noPopShadow:!0}};var d,i,n;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    top: 'none',
    width: 'full'
  },

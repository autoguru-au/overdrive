...
}`,...o.parameters?.docs?.source},description:{story:"Layout variants to demonstrate alignment, expanded children, reverse order, and wrapping behavior.",...o.parameters?.docs?.description}}};const O=["Standard","Responsive","InteractiveElements","MoreExamples"];export{s as InteractiveElements,o as MoreExamples,i as Responsive,d as Standard,O as __namedExportsOrder,L as default};

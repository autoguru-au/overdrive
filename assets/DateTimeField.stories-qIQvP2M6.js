...
<TimeField
  ...
  disabled={isSubmitting}
/>
\`\`\``,name:"children",required:!0,type:{name:"ReactNode"}},testId:{defaultValue:null,description:"The test ID will be rendered as a data attribute `data-testid` on the element for use with test assertions",name:"testId",required:!1,type:{name:"string"}},as:{defaultValue:null,description:"Name of HTML tag or a React/JSX component to render the component as",name:"as",required:!1,type:{name:"AsProp"}},className:{defaultValue:null,description:"Flexible className that accepts strings, arrays and objects",name:"className",required:!1,type:{name:"ClassValue"}}}}}catch{}const Z={timeLabel:"time",select:"select"},f=k.forwardRef(({defaultValue:s,disabled:r=!1,invalid:n=!1,lang:i={},loading:d=!1,name:l,onChange:t,testId:a,timeOptions:T,value:F},j)=>{const h=k.useRef(null),b=r||d,C={...Z,...i},y=()=>{if("showPicker"in HTMLSelectElement.prototype&&h.current)try{h.current.showPicker()}catch{}},S=F===void 0?{defaultValue:s??""}:{value:F};return e.createElement("label",{className:J,onClick:y,onMouseLeave:()=>{h?.current?.blur()},"aria-disabled":b,...V({invalid:n,loading:d,"od-component":"time-field",testId:a}),ref:j},e.createElement("div",{className:R({disabled:r,invalid:n})},C.timeLabel),d?e.createElement(q,{height:"6"}):e.createElement("select",{name:l,className:_,...S,disabled:b,onChange:c=>{b||t?.(c.target.value)},onClick:c=>{c.stopPropagation()},ref:h},e.createElement("option",{value:"",disabled:!0},C.select),T.map(c=>e.createElement("option",{key:c.name,value:c.name},c.label))))});f.displayName="TimeField";try{f.displayName="TimeField",f.__docgenInfo={description:`TimeField is a sub-component for selecting a time from predefined options.

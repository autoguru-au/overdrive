...
}`,...r.parameters?.docs?.source},description:{story:"Demonstrates the `odComponent` and `testId` props that map to data attributes built into Box and a custom attribute",...r.parameters?.docs?.description}}};const n=["Standard","ResponsiveProps","DataAttributes"];export{r as DataAttributes,e as ResponsiveProps,s as Standard,n as __namedExportsOrder,d as default};

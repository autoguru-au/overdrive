import{e as o,B as a,H as l}from"./iframe-CASYvVkN.js";import{F as n}from"./FillHeightBox-Bx5gjcEy.js";import{T as s}from"./Text-CoEgeyZ5.js";import{S as d}from"./StickyBox-BQYr8kJU.js";import"./preload-helper-PPVm8Dsz.js";import"./useResponsiveValue-C51V9mSH.js";import"./useMedia-DOR9trxN.js";import"./resolveResponsiveProps-TiRU7Y2q.js";import"./ScrollPane-T7BCTJYu.js";const S={title:"Layout/StickyBox",component:d},e={args:{top:"none",width:"full"},render:i=>o.createElement(n,{includeMobile:!0,bottomGap:"5",width:"full",backgroundColor:"white",borderColor:"default",borderWidth:"1",boxShadow:"1",height:"full",borderRadius:"1"},o.createElement(d,{...i},o.createElement(a,{marginTop:"9",padding:"3",width:"full",backgroundColor:"yellow700",borderRadius:"1",overflow:"hidden"},o.createElement(l,{as:"h2",color:"white"},"I'm a sticky header"))),o.createElement(a,{padding:"5",width:"full",style:{minHeight:"300vh"}},Array.from({length:100}).map((m,t)=>o.createElement(s,{key:t,as:"p"},"I am page content ",t+1))))},r={...e,args:{...e.args,noPopShadow:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    top: 'none',
    width: 'full'
  },

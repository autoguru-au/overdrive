import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as o}from"./index-DD3Cz93e.js";import{M as s,f as r}from"./blocks-DwYb61-v.js";import"./iframe-DUkgvalV.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D5QrLjuV.js";import"./index-CoZyPIWB.js";const i=`# @autoguru/overdrive
...
- 3c0a2ee: Restore the build output in the published package. 6.0.0 shipped without \`dist/\`
...
- 768d084: fix(tokens): give \`color.link.secondary\` a dark-surface value
...
- 768d084: fix(TextLink): draw the underline on focus, not only on hover
...
- 768d084: fix(TextLink): make action-only links operable, and ring every link on focus
...
- 5940b1e: Add \`StepProgress\`, the DS-2026 multi-step progress indicator, and the
  ...
  existing changes.
- 219eb63: feat(ToggleButtons): honour the \`orientation\` prop
...
`;function a(n){return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Changelog"}),`
`,e.jsx(r,{children:i})]})}function m(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a()}export{m as default};

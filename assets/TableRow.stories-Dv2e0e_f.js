import{e}from"./iframe-C9Ql_8pE.js";import{D as m}from"./DataTable-BGXWh2f2.js";import{a,T as n,b as t,c as l,d}from"./Table-q_Pg0-wY.js";import"./preload-helper-PPVm8Dsz.js";import"./ScrollPane-MsaCX6tg.js";import"./Text-Cl0BjDM8.js";import"./flex-Blzo1G7q.js";import"./Icon-DX3P_hEq.js";import"./resolveResponsiveProps-6v5T8fj2.js";import"./ArrowsDownUpIcon-CABO2Icg.js";const R={title:"Components/Table/TableRow",component:a,parameters:{docs:{description:{component:["`TableRow` is the row primitive used inside `Table` and `DataTable`.","","It renders as a native `<tr>` with `display: contents`, so the row participates in the parent grid layout without adding a layout box of its own. The row also opts into a staggered entrance animation via the `staggerIndex` prop."].join(`

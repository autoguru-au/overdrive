import{e}from"./iframe-CASYvVkN.js";import{D as m}from"./DataTable-hdXIU6Ou.js";import{a,T as n,b as t,c as l,d}from"./Table-BIEXIbXI.js";import"./preload-helper-PPVm8Dsz.js";import"./ScrollPane-T7BCTJYu.js";import"./Text-CoEgeyZ5.js";import"./flex-KZS8z0gz.js";import"./Icon-CeLWjYP4.js";import"./resolveResponsiveProps-TiRU7Y2q.js";import"./ArrowsDownUpIcon-B-oziZdC.js";const R={title:"Components/Table/TableRow",component:a,parameters:{docs:{description:{component:["`TableRow` is the row primitive used inside `Table` and `DataTable`.","","It renders as a native `<tr>` with `display: contents`, so the row participates in the parent grid layout without adding a layout box of its own. The row also opts into a staggered entrance animation via the `staggerIndex` prop."].join(`

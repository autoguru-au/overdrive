import{e as o,B as a,H as l}from"./iframe-BIDnS-AI.js";import{F as n}from"./FillHeightBox-CUhUH0fo.js";import{T as s}from"./Text-DKPjkgnB.js";import{S as d}from"./StickyBox-ITWHlZRf.js";import"./preload-helper-PPVm8Dsz.js";import"./useResponsiveValue-B8AHUAKb.js";import"./useMedia-C2J_HcY2.js";import"./resolveResponsiveProps-CwZrgFwa.js";import"./ScrollPane-Bi2d4y7H.js";const S={title:"Layout/StickyBox",component:d},e={args:{top:"none",width:"full"},render:i=>o.createElement(n,{includeMobile:!0,bottomGap:"5",width:"full",backgroundColor:"white",borderColor:"default",borderWidth:"1",boxShadow:"1",height:"full",borderRadius:"1"},o.createElement(d,{...i},o.createElement(a,{marginTop:"9",padding:"3",width:"full",backgroundColor:"yellow700",borderRadius:"1",overflow:"hidden"},o.createElement(l,{as:"h2",color:"white"},"I'm a sticky header"))),o.createElement(a,{padding:"5",width:"full",style:{minHeight:"300vh"}},Array.from({length:100}).map((m,t)=>o.createElement(s,{key:t,as:"p"},"I am page content ",t+1))))},r={...e,args:{...e.args,noPopShadow:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    top: 'none',
    width: 'full'
  },

import{A as M,r as k,e,E as V,u as L,i as H}from"./iframe-g_fQEFxq.js";import{M as Y}from"./mockdate-BKvIeonN.js";import{u as G,s as E,d as z,f as U}from"./useCalendarPopover-DpTj2H8w.js";import{C as $}from"./Calendar-DxNx-qN-.js";import{L as q}from"./LoadingBox-D_rMRpU_.js";import{P as K}from"./PopoverTrigger-DdqCumtN.js";import"./preload-helper-PPVm8Dsz.js";import"./useControlledState-Co4Nn5pS.js";import"./useButton-ChJS02lu.js";import"./index-D2jrpSP5.js";import"./index-D6R5Ynk5.js";import"./LocalizedStringFormatter-Bbt7CFPC.js";import"./Icon-D8KLDBn4.js";import"./resolveResponsiveProps-Dst2Z044.js";import"./ChevronLeftIcon-BC3nbN2_.js";import"./ChevronRightIcon-DEN201tU.js";import"./Button-CHlbr4mX.js";import"./ProgressSpinner-DmeSjlgN.js";import"./useMedia-Bytk1kXs.js";import"./number-P4c4HRxZ.js";import"./CloseIcon-Cji5prnT.js";var W="eky8in2 eky8in1 eky8in0 onxwju0 onxwjub onxwjum onxwjux onxwju2n onxwju2l onxwju2p onxwju2r onxwjucx onxwjuch onxwjudd onxwjudt onxwjuth onxwjuul onxwjuvp onxwjuwt onxwju3f onxwjubx onxwju6l onxwjupx onxwjupl onxwju8h onxwjuax tq83zq0",J="eky8in3 eky8in1 eky8in0 onxwju0 onxwjub onxwjum onxwjux onxwju2n onxwju2l onxwju2p onxwju2r onxwjucx onxwjuch onxwjudd onxwjudt onxwjuth onxwjuul onxwjuvp onxwjuwt onxwju3f onxwjubx onxwju6l onxwjupx onxwjupl onxwju8h onxwjuax",R=M({defaultClassName:"eky8in7 _18vhvlid _18vhvlim yhjp33f eky8in4 onxwjua1 onxwju91 onxwju5m onxwjuax onxwju5p eky8in5 yhjp338",variantClassNames:{invalid:{true:"eky8in8 eky8in6 onxwju2w"},disabled:{true:"eky8in9"}},defaultVariants:{},compoundVariants:[]}),_="eky8ind eky8ina _18vhvlid _18vhvlim yhjp33f eky8inb onxwjua9 onxwju99 onxwju5k onxwju5n eky8inc yhjp338";const X={dateLabel:"date",select:"select"},p=k.forwardRef(({allowPastDate:s=!1,calendarOptions:r,defaultValue:n,disabled:i=!1,invalid:d=!1,lang:l={},loading:t=!1,max:a,min:T,name:F,onChange:j,testId:h,value:b},C)=>{const{selectedDate:y,handleCalendarChange:S,setPopoverState:c}=G({value:b,defaultValue:n,onChange:j}),A=i||t,v={...X,...l},O={nextLabel:v.nextLabel,prevLabel:v.prevLabel},P={close:v.close},N={defaultValue:y,minValue:T?E(T):void 0,maxValue:a?E(a):void 0,...r};return e.createElement("div",{...V({"od-component":"date-field",testId:h})},e.createElement(K,{content:e.createElement($,{allowPastDate:s,calendarOptions:N,lang:O,onChange:S}),lang:P,offset:1,onStateReady:c,placement:"bottom left",isDisabled:A},e.createElement("button",{className:W,...V({disabled:i,loading:t,invalid:d})},e.createElement("div",{className:R({disabled:i,invalid:d})},v.dateLabel),t?e.createElement(q,{height:"6"}):e.createElement("div",{className:_,...V({disabled:i})},y?z(y):v.select))),e.createElement("input",{name:F,value:U(y),type:"hidden",disabled:i,ref:C}))});p.displayName="DateField";try{p.displayName="DateField",p.__docgenInfo={description:`DateField is a sub-component for selecting a date with a Calendar popup.
...
<TimeField
  ...
  disabled={isSubmitting}
/>
\`\`\``,name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:null,description:"Flexible className that accepts strings, arrays and objects",name:"className",required:!1,type:{name:"ClassValue"}},as:{defaultValue:null,description:"Name of HTML tag or a React/JSX component to render the component as",name:"as",required:!1,type:{name:"AsProp"}},testId:{defaultValue:null,description:"The test ID will be rendered as a data attribute `data-testid` on the element for use with test assertions",name:"testId",required:!1,type:{name:"string"}}}}}catch{}const Z={timeLabel:"time",select:"select"},f=k.forwardRef(({defaultValue:s,disabled:r=!1,invalid:n=!1,lang:i={},loading:d=!1,name:l,onChange:t,testId:a,timeOptions:T,value:F},j)=>{const h=k.useRef(null),b=r||d,C={...Z,...i},y=()=>{if("showPicker"in HTMLSelectElement.prototype&&h.current)try{h.current.showPicker()}catch{}},S=F===void 0?{defaultValue:s??""}:{value:F};return e.createElement("label",{className:J,onClick:y,onMouseLeave:()=>{h?.current?.blur()},"aria-disabled":b,...V({invalid:n,loading:d,"od-component":"time-field",testId:a}),ref:j},e.createElement("div",{className:R({disabled:r,invalid:n})},C.timeLabel),d?e.createElement(q,{height:"6"}):e.createElement("select",{name:l,className:_,...S,disabled:b,onChange:c=>{b||t?.(c.target.value)},onClick:c=>{c.stopPropagation()},ref:h},e.createElement("option",{value:"",disabled:!0},C.select),T.map(c=>e.createElement("option",{key:c.name,value:c.name},c.label))))});f.displayName="TimeField";try{f.displayName="TimeField",f.__docgenInfo={description:`TimeField is a sub-component for selecting a time from predefined options.

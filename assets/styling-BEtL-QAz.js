import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as d}from"./index-Ccct_ITB.js";import{M as i}from"./blocks-DloLzfAm.js";import"./iframe-BHjXsG_y.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C1xxptEQ.js";import"./index-BI1oPTpU.js";function r(s){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Styling",tags:["new"]}),`
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"size"})," prop accepts either a size-scale token (",e.jsx(n.code,{children:"'1'"}),"–",e.jsx(n.code,{children:"'9'"}),`) or a Design
System 2026 named style (`,e.jsx(n.code,{children:"'h1'"}),"–",e.jsx(n.code,{children:"'h4'"}),", ",e.jsx(n.code,{children:"'p1'"}),"–",e.jsx(n.code,{children:"'p4'"}),`). Named styles also apply
their default weight (bold for headings, normal for paragraphs) unless `,e.jsx(n.code,{children:"weight"}),`
or `,e.jsx(n.code,{children:"strong"})," is set."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Example:"})}),`
...
const Caption = ({ children }) => {
  return <span className={typography({ size: 'p3' })}>{children}</span>;
};
`})}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsxs(n.p,{children:["Space tokens: (",e.jsx(n.code,{children:'"none"'}),", ",e.jsx(n.code,{children:'"0"'}),", ",e.jsx(n.code,{children:'"1"'}),", ",e.jsx(n.code,{children:'"2"'}),", ",e.jsx(n.code,{children:'"3"'}),", ",e.jsx(n.code,{children:'"4"'}),", ",e.jsx(n.code,{children:'"5"'}),", ",e.jsx(n.code,{children:'"6"'}),", ",e.jsx(n.code,{children:'"7"'}),`,
`,e.jsx(n.code,{children:'"8"'}),", ",e.jsx(n.code,{children:'"9"'}),", ",e.jsx(n.code,{children:'"10"'}),", ",e.jsx(n.code,{children:'"11"'}),", ",e.jsx(n.code,{children:'"12"'}),")"]}),`
...
`]}),`
`,e.jsx(n.h3,{id:"colours",children:"Colours"}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:e.jsx(n.code,{children:"colour"})})," - Text colour using legacy intentional colorset"]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Border Colour:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`

...
}`,...i.parameters?.docs?.source},description:{story:"The indeterminate checkbox will typically be set by the parent component in a form with nested checkboxes.\nThe indeterminate prop cannot be set by the component itself. This example uses an `onClick` handler to toggle\nthe checked state when the indeterminate checkbox is clicked, the checkbox does not natively have this behaviour.",...i.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: ({
    disabled,
    onChange
  }) => {
...
}`,...f.parameters?.docs?.source}}};const Z=["Default","Disabled","Indeterminate","List","MultipleLines","WithComponent","WithMultiLineComponent"];export{d as Default,u as Disabled,i as Indeterminate,m as List,p as MultipleLines,h as WithComponent,f as WithMultiLineComponent,Z as __namedExportsOrder,X as default};

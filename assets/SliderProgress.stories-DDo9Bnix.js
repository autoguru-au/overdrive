import{e as o,B as s}from"./iframe-D_ivnAPa.js";import{b as n}from"./argTypes-box-CL3AxB5o.js";import{S as d}from"./SliderProgress-CNDpWI7I.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,g={title:"Primitives/Indicators/Slider Progress",component:d,argTypes:{backgroundColour:n.backgroundColour},decorators:[t=>o.createElement(s,{paddingY:"8",paddingX:"3",backgroundColour:"gray800"},o.createElement(t,null))]},r={args:{paused:!1,totalCount:3,activeIndex:1,duration:"1s",onRequestNext:()=>c("onRequestNext")}},a={args:{...r.args,backgroundColour:"yellow500"}},e={args:{...r.args,activeIndex:5,totalCount:20}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    paused: false,
    totalCount: 3,
    activeIndex: 1,

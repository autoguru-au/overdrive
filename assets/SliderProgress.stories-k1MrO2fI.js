import{e as o,B as s}from"./iframe-euna8s5s.js";import{b as n}from"./argTypes-box-DIYkyxDG.js";import{S as d}from"./SliderProgress-BbfQScF0.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,g={title:"Primitives/Indicators/Slider Progress",component:d,argTypes:{backgroundColour:n.backgroundColour},decorators:[t=>o.createElement(s,{paddingY:"8",paddingX:"3",backgroundColour:"gray800"},o.createElement(t,null))]},r={args:{paused:!1,totalCount:3,activeIndex:1,duration:"1s",onRequestNext:()=>c("onRequestNext")}},a={args:{...r.args,backgroundColour:"yellow500"}},e={args:{...r.args,activeIndex:5,totalCount:20}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    paused: false,
    totalCount: 3,
    activeIndex: 1,

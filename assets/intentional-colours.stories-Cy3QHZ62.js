import{e,H as n,o}from"./iframe-B8iXgyt9.js";import{S as a,l as d,v as g}from"./index-fyR1MO4e.js";const s=({label:t,cssVar:r})=>e.createElement(a,{space:"xxs",key:t},e.createElement("div",{className:g({shape:"rectangle"}),style:{background:r}}),e.createElement("span",{className:d},t)),c=({vars:t})=>e.createElement(a,{space:"sm",horizontal:!0},Object.entries(t).map(([r,h])=>e.createElement(a,{space:"xxs",key:r},e.createElement("div",{className:g({shape:"rectangle"}),style:{background:h}}),e.createElement("span",{className:d},r)))),p=({vars:t})=>e.createElement(a,{space:"sm"},e.createElement(a,{space:"sm",horizontal:!0},e.createElement(s,{label:"Border",cssVar:t.border}),e.createElement(s,{label:"Foreground",cssVar:t.foreground})),e.createElement(a,{space:"sm",horizontal:!0},e.createElement(s,{label:"Background strong",cssVar:t.background.strong}),e.createElement(s,{label:"Background standard",cssVar:t.background.standard}),e.createElement(s,{label:"Background mild",cssVar:t.background.mild}))),S={title:"Foundation/Legacy Coloursets",tags:["!autodocs"]},l={render:()=>e.createElement(a,null,e.createElement("hgroup",null,e.createElement(n,{as:"h1"},"Intentional Colours"),e.createElement("p",null,"These colours are being phased out but include use with flat-red and neutral themes plus colour overrides."),e.createElement("p",null,"Use the theme selection menu options in the top bar to view alternate colour mappings.")),e.createElement(a,{space:"md",horizontal:!0},e.createElement(a,null,e.createElement(n,{as:"h2"},"Body"),e.createElement(c,{vars:o.body})),e.createElement(a,null,e.createElement(n,{as:"h2"},"Foreground"),e.createElement(c,{vars:o.colours.foreground})),e.createElement(a,null,e.createElement(n,{as:"h2"},"Background"),e.createElement(c,{vars:o.colours.background})),e.createElement(a,null,e.createElement(n,{as:"h2"},"Border"),e.createElement(c,{vars:o.border.colours}))),e.createElement(a,null,e.createElement(n,{as:"h2"},"Typography"),e.createElement(c,{vars:o.typography.colour})),e.createElement(a,null,e.createElement(n,{as:"h2"},"Intentional colour sets"),e.createElement(a,{space:"lg",horizontal:!0},Object.entries(o.colours.intent).map(([t,r])=>e.createElement("div",{key:t},e.createElement(n,{as:"h4",className:d},t),e.createElement(p,{vars:r}))))))};var m,i,u;l.parameters={...l.parameters,docs:{...(m=l.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => {
    return <Stack>
                <hgroup>
...
}`,...(u=(i=l.parameters)==null?void 0:i.docs)==null?void 0:u.source}}};const v=["LegacyColoursets"];export{l as LegacyColoursets,v as __namedExportsOrder,S as default};

import{u as h,r as c,f as V,e,z as X,v as a,S as W}from"./iframe-BNimcw7I.js";import{B as d}from"./Button-C8v7PRHz.js";import{T as t}from"./Text-Bm6LeYFJ.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon-Cj-g7sro.js";import"./resolveResponsiveProps-CokS9ksv.js";import"./ProgressSpinner-BekTt4R6.js";const z=({children:n})=>n?typeof n=="boolean"?e.createElement(t,{"aria-hidden":!0},"•"):c.isValidElement(n)?e.createElement("div",{"aria-hidden":!0},n):e.createElement(t,{"aria-hidden":!0},n):null,r=({as:n="div",children:u,className:v,alignX:x,alignY:p="center",dividers:m,noWrap:y,space:E="2",width:w})=>{const{Component:C,componentProps:T}=h({as:n,className:v,odComponent:"inline",alignItems:p,display:"flex",flexDirection:"row",flexWrap:y?"nowrap":"wrap",gap:E,justifyContent:x,width:w}),g=c.useMemo(()=>V(u),[u]),b=X(n),{Component:S,componentProps:B}=h({as:b,alignItems:p,display:"flex",flexWrap:"nowrap",useVar:"gap"});return g.length===0?null:e.createElement(C,{...T},c.Children.map(g,(f,I)=>f&&e.createElement(S,{...B},m&&I>0&&e.createElement(z,null,m),f)))};try{r.displayName="Inline",r.__docgenInfo={description:`Inline arranges child elements horizontally, side by side.

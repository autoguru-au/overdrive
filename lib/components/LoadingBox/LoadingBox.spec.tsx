...
describe('<LoadingBox />', () => {
	...
	it('renders with custom className', () => {
		render(<LoadingBox className="custom-class" data-testid="loading-box" />);
	...
	it('renders with valid background color', () => {
		render(<LoadingBox backgroundColour="gray300" data-testid="loading-box" />);
	...
	it('handles min and max random width boundaries', () => {
		...
		const { rerender } = render(<LoadingBox randomWidth data-testid="min-box" />);

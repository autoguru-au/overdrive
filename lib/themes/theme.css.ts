		...
		button: {
			primary: {
				solid: {
					...
					borderPressed: 'color-button-primary-solid-border-pressed',
					text: 'color-button-primary-solid-text',
				},
				outlined: {
					borderText: 'color-button-primary-outlined-border-text',
			...
			critical: {
				solid: {
					...
					borderPressed: 'color-button-critical-solid-border-pressed',
					text: 'color-button-critical-solid-text',
				},
				outlined: {
					borderText: 'color-button-critical-outlined-border-text',
			...
			linkedText: {
				primary: 'color-button-linked-text-primary',
				secondary: 'color-button-linked-text-secondary',
				hover: 'color-button-linked-text-hover',
				pressed: 'color-button-linked-text-pressed',
				critical: 'color-button-linked-text-critical',
				criticalHover: 'color-button-linked-text-critical-hover',
				criticalPressed: 'color-button-linked-text-critical-pressed',
			},
		},
		illustration: {
